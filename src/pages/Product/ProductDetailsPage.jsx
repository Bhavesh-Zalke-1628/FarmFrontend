...
//     const [rating] = useState(4.5); // Simulated static rating
...
//         <Layout>
//             {/* Product Details */}
//             <div className="max-w-6xl mx-auto px-4 py-16 grid grid-cols-1 lg:grid-cols-2 gap-10">
//                 {/* Image */}
//                 <div className="bg-white p-4 rounded-lg shadow">
//                     <img
//                         src={product?.img?.secure_url || "https://via.placeholder.com/500x400"}
//                         alt={product.name}
...
//                                 <div className="mb-4">
//                                     <div className="text-xl text-gray-500 line-through">₹{product.price}</div>
...
//                             <div>Stock: {product?.quantity > 0 ? `${product.quantity} Available` : 'Out of Stock'}</div>
...
//                             <div className="flex items-center border rounded px-3 py-2 w-fit">
//                                 <button onClick={() => handleQuantityChange('dec')} className="text-lg font-bold px-2">−</button>
//                                 <span className="px-4">{quantity}</span>
//                                 <button onClick={() => handleQuantityChange('inc')} className="text-lg font-bold px-2">+</button>
//                             </div>
//                             <button
//                                 onClick={handleAddToCart}
//                                 className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded transition w-full sm:w-auto"
//                             >
//                                 Add to Cart
//                             </button>
//                         </div>
...
//                 <h2 className="text-2xl font-bold text-green-700 mb-4">Why Choose GreenFields?</h2>
//                 <p className="text-gray-600 max-w-3xl mx-auto text-base sm:text-lg leading-relaxed">
//                     At GreenFields, we believe in delivering premium, pesticide-free produce straight from local farms.
//                     Our platform connects farmers and consumers directly to ensure affordability, quality, and freshness.
//                     Support sustainability and your health with every purchase.
//                 </p>
//             </div>
...
//                                     />
//                                     <h3 className="text-lg font-semibold text-green-700 mb-1">{item.name}</h3>
...
//                                                     ₹{Math.round(item.price - (item.price * item.offerPercentage) / 100)}
//                                                 </>
//                                             ) : (
//                                                 <>₹{item.price}</>
//                                             )
